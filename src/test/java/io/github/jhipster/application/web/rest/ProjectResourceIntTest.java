...
public class ProjectResourceIntTest {
    ...
    private static final Long DEFAULT_NUM_STUDENT = 1L;
    private static final Long UPDATED_NUM_STUDENT = 2L;
    ...
    public void getAllProjects() throws Exception {
        ...
        restProjectMockMvc.perform(get("/api/projects?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].numStudent").value(hasItem(DEFAULT_NUM_STUDENT.intValue())))
    ...
    public void getProject() throws Exception {
        ...
        restProjectMockMvc.perform(get("/api/projects/{id}", project.getId()))
            ...
            .andExpect(jsonPath("$.numStudent").value(DEFAULT_NUM_STUDENT.intValue()))
